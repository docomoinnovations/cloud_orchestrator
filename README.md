...
The distribution manages resources in public and private clouds. Version 3.x includes support for Amazon EC2 and Amazon VPC/Networking, Kubernetes, OpenStack, and Terraform.
...
To use 3.x use the following command.

```
composer create-project docomoinnovations/cloud_orchestrator:3.x-dev cloud_orchestrator
```
