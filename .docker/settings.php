 ...
 * @endcode
 */
$settings['hash_salt'] = '2CTVaMR1ry5UUOT-0P2ibDvMPxe639cFGw-HPdlEPtmOBAhnqNnnlykkSOo6X931WuqNlm4Jvg';
...
$settings['file_private_path'] = '/var/www/html/docroot/private';

$freshinstall = getenv('FRESH_SETUP');
if (getenv('FRESH_SETUP')) {
